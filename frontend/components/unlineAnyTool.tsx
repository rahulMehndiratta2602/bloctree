    ...
    <div className="text-white -mt-[40vh]">
        <Container>
            <div className="text-center">
                <h2 className="mb-4 text-[3rem] font-bold md:mb-7 md:text-[7rem]">
                    <span className="text-[4rem] md:text-[8rem]">Unlike any tool</span>
                    <br /> you&apos;ve used before
                </h2>
                <p className="mx-auto mb-12 max-w-[68rem] text-sm text-primary-text md:mb-7 md:text-lg">
