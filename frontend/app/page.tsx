    ...
    return (
        <Container>
            <Hero>
                <HeroTitle>
                Your 
                <span className="relative m-2 text-transparent font-extrabold wireframe-web3">Web3</span> 
                Hub in <br /> One Link.
                </HeroTitle>
                <HeroSubtitle>
                    Join 50M+ users simplifying their digital presence with Linktree. Connect your
                    <span className=' text-yellow-400'> Web3 Projects, NFTs, and Social Profiles</span> all in one place—effortlessly share and
                    manage everything with a single link.
                </HeroSubtitle>
                <Image className='md:hidden' src={heroImage} priority={true} alt="Hero Image" />
                <ContainerScroll>
